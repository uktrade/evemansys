"""
Django settings for evemansys_project project.
...
APPS_DIR = ROOT_DIR.path('evemansys')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'evemansys.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Peter Nociar""", 'peter.nociar@digital.trade.gov.uk'),
]
...
########## CELERY
INSTALLED_APPS += ['evemansys.taskapp.celery.CeleryConfig']
